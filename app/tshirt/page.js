  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        // Prefer showing default product image; fallback to first variant img
              ...
              >
                <div>
                  <div className="block relative h-48 rounded overflow-hidden">
                    <Image
                      alt={product.title}
                      src={product.displayImg || "https://m.media-amazon.com/images/I/71eUwDk8z+L._SY879_.jpg"}
